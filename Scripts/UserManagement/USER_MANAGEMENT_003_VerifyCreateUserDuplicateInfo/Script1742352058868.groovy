...
//Verify duplicate username, email format
WebUI.setText(findTestObject('Object Repository/UserManagementPage/CreateUser/txt_UserName'), "dina")
WebUI.setText(findTestObject('Object Repository/UserManagementPage/CreateUser/txt_Email'), "dina@gmail.com")
WebUI.setText(findTestObject('Object Repository/UserManagementPage/CreateUser/txt_Password'), "nana12345")
...
WebUI.verifyElementText(findTestObject('Object Repository/UserManagementPage/CreateUser/msg_DuplicateUsername'), 'Username is already taken')
